...
Random.seed!(1234)
path = raw"path\to\PA-Experiments"
...
CS_avg_nondominated_paths = pulse_info_CS["number_nondominanted_paths"] 
CS_avg_elapsed_time = pulse_info_CS["total_elapsed_time"] 
CS_avg_pruned_by_bounds = pulse_info_CS["pruned_by_bounds"] 
CS_avg_length_pruned_by_bounds = (pulse_info_CS["total_length_pruned_by_bounds"] ./ pulse_info_CS["pruned_by_bounds"])
CS_avg_nondominated_paths_erspa = erspa_info_CS["number_nondominanted_paths"]
CS_avg_elapsed_time_erspa = erspa_info_CS["total_elapsed_time"]
...
PH_avg_nondominated_paths = pulse_info_PH["number_nondominanted_paths"]
PH_avg_elapsed_time = pulse_info_PH["total_elapsed_time"] 
PH_avg_pruned_by_bounds = pulse_info_PH["pruned_by_bounds"]
PH_avg_length_pruned_by_bounds = pulse_info_PH["total_length_pruned_by_bounds"] ./ pulse_info_PH["pruned_by_bounds"]
PH_avg_nondominated_paths_erspa = erspa_info_PH["number_nondominanted_paths"]
PH_avg_elapsed_time_erspa = erspa_info_PH["total_elapsed_time"]
...
SY_avg_nondominated_paths = pulse_info_SY["number_nondominanted_paths"]
SY_avg_elapsed_time = pulse_info_SY["total_elapsed_time"]
SY_avg_pruned_by_bounds = pulse_info_SY["pruned_by_bounds"]
SY_avg_length_pruned_by_bounds = (pulse_info_SY["total_length_pruned_by_bounds"] ./ pulse_info_SY["pruned_by_bounds"])
SY_avg_nondominated_paths_erspa = erspa_info_SY["number_nondominanted_paths"]
SY_avg_elapsed_time_erspa = erspa_info_SY["total_elapsed_time"]
...
### DFs ###
df_time = DataFrame(CS_t = CS_avg_elapsed_time, CS_t_ERSPA = CS_avg_elapsed_time_erspa, 
                    PH_t = PH_avg_elapsed_time, PH_t_ERSPA = PH_avg_elapsed_time_erspa,
                    SY_t = SY_avg_elapsed_time, SY_t_ERSPA = SY_avg_elapsed_time_erspa)

CSV.write("time_sdrspp.csv", df_time)

df_nondominated = DataFrame(CS_n = CS_avg_nondominated_paths, CS_n_ERSPA = CS_avg_nondominated_paths_erspa,
                            PH_n = PH_avg_nondominated_paths, PH_n_ERSPA = PH_avg_nondominated_paths_erspa,
                            SY_n = SY_avg_nondominated_paths, SY_n_ERSPA = SY_avg_nondominated_paths_erspa)
